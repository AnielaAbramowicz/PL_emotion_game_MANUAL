...
class StartTrail:
    def __init__(self, root, game_state):
        ...
        self.label = tk.Label(
            self.main_frame,
            text="CZEŚĆ!\nWitaj w ręcznej grze rozpoznającej emocje!",
            font=("Monocraft", 68),
            bg=bg_color,
            fg=text_color,
            wraplength=1000,
        ...
        self.label2 = tk.Label(
            self.main_frame,
            text="Możesz samodzielnie ustawić poziom trudności! Gotowa? Kliknij przycisk, by rozpocząć rundę testową!",
            font=("Monocraft", 40),
            bg=bg_color,
            fg=text_color,
            wraplength=1000,
        ...
        self.start_button.bind("<ButtonRelease-1>", lambda e: self.start_game())
