...
class EmotionQuestionScreen:
    def __init__(self, root, game_state):
        ...
        button_blue_raw = Image.open("/Users/anielamac/Desktop/thesis/visualization/buttom_blue.png").resize((300, 70))
        ...
        message_red_raw = Image.open("/Users/anielamac/Desktop/thesis/visualization/mess_red.png").resize((400, 150))
        self.message_red = ImageTk.PhotoImage(message_red_raw)

        button_purple_raw = Image.open("/Users/anielamac/Desktop/thesis/visualization/button_purple.png").resize((250, 60))
